...
class ClientController extends Controller
{
    ...
    public function AddLegalNeed(Request $request)
    {
        ...
        $case = CaseModel::create([
            'id' => $userId,
            'DateOfNextAppearance' => $validatedData['DateOfNextAppearance'],
            'NatureOfAppearance' => $validatedData['NatureOfAppearance'],
            'ServicesLanguage' => $validatedData['ServicesLanguage'],
        ...
        $legalRepresentation = LegalRepresentation::create([
            'CaseID' => $caseID,
            'ReasonForChange' => $validatedData['ReasonForChange'],
        ]);
        ...
        $signature = Signature::create([
            ...
            'PrintName' => $validatedData['PrintName'],
