        ...
        >
            ...
            <h2 className="text-2xl font-bold mb-6 border-b pb-2">Lawyer Details</h2>
                ...
                <div className="p-4 bg-gray-50 rounded">
                    <h3 className="font-bold mb-2 text-gray-800">Lawyer Information</h3>
                    <div className="space-y-2">
                        <div>
                            <label className="block mb-1 font-medium text-gray-600">Name</label>
                            <div className="p-2 bg-white border rounded">{lawyerData?.FirstName ?? 'N/A'} {lawyerData?.LastName ?? 'N/A'}</div>
                        </div>
                        <div>
                            <label className="block mb-1 font-medium text-gray-600">Email</label>
                            <div className="p-2 bg-white border rounded">{lawyerData?.email ?? 'N/A'}</div>
                        </div>
                        <div>
                            <label className="block mb-1 font-medium text-gray-600">Phone Number</label>
                            <div className="p-2 bg-white border rounded">{lawyerData?.Phone ?? 'N/A'}</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-4 bg-gray-50 rounded">
                    <h3 className="font-bold mb-2 text-gray-800">Client Information</h3>
                    <div className="space-y-2">
                        <div>
                            <label className="block mb-1 font-medium text-gray-600">Name</label>
