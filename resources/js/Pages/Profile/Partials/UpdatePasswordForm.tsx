...
export default function UpdatePasswordForm({ className = '' }: ClassName) {
    const passwordInput = createRef<HTMLInputElement>();
    const currentPasswordInput = createRef<HTMLInputElement>();
            ...
            <form onSubmit={updatePassword} className="mt-6 space-y-6">
                <div>
                    ...
                    <TextInput
                        ...
                        onChange={(e: ChangeEvent) => setData('current_password', e.target.value)}
                        type="password"
